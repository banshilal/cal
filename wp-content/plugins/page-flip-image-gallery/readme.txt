...
Do you need to show your photos to the best advantage and post them in a photo gallery speedy manner, don't you? You need to make a bright and memorable presentation, portfolio or image gallery?

Try FlippingBook <a href='http://pageflipgallery.com/' title='Wordpress Gallery Plugin'>Wordpress Gallery plugin</a> - image gallery with page flip effect.
<a href='http://pageflipgallery.com/online-demo/' title='FlippingBook Wordpress Gallery Plugin Demo'>Live Demo</a>

Features:

* FlippingBook WP Gallery Page Editor
...
* Enable Zoom!
* Use JPG, GIF, SWF files as a page for your Flipping Book
* Full screen mode
* Navigation bar 
* Enable print option
...
* New! WP Gallery FlippingBook Page Editor
* WP 3.4.2 compatibility
...
* Minor Bugs fixed
* WP 3.3.2 compatibility

0.5.13.1

* New version of the FlippingBook
* WP 3.2.1 compatibility
...
* Fixed many bugs
* New Wordpress Gallery Plugin features
...
Based on <a href='http://flippingbook.com/' title='Page Flip'>Page Flip</a> FlippingBook Engine
== Installation ==

This flipping book plugin is simple to install and can be done in a matter of minutes. The following steps will guide you through the process of Page Flip wordpress gallery plugin installation:
...
4. If you need help, review the Flip Book gallery plugin <a href='http://pageflipgallery.com/docs/' title='FlippingBook Wordpress Gallery Plugin Tutorials and FAQ'>FAQ</a>.
...
Copyright 2008-2012 FlippingBook WP team / The best Wordpress Gallery plugin solution

== Screenshots ==

1. <a href='http://pageflipgallery.com/demo/' title='Page Flip Book Flipping'>Page Flip Book Flipping</a>
2. <a href='http://pageflipgallery.com/' title='Wordpress Gallery Plugin'>Wordpress Gallery Plugin</a>
3. <a href='http://flippingbook.com/' title='Page Flip'>Page Flip</a> FlippingBook Engine
4. <a href='http://pageflipgallery.com/page-editor/' title='WordPress Gallery Page Editor'>Gallery Page Editor</a>