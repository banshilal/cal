...
class pageflipAlbum
{
	...
	function pageflipAlbum( $id, $pageWidth, $pageHeight, $name = '', $type = '', $backgroundColor = '', $frameColor = '', $frameSize = 0 )
	{
		$this->id = $id;
	...
	function addPage( $id, $template, $backgroundColor = '', $frameColor = '', $frameSize = '', $caption = '', $type = '' )
	{
		...
		$this->pages[] = new pageflipAlbumPage( $id, $template, $backgroundColor, $frameColor, $frameSize, $caption, $type );
	...
	{
		$this->images[(int)$id] = new pageflipAlbumImage( $id, $thumb, $width, $height );
...
class pageflipAlbumPage
{
	...
	function pageflipAlbumPage( $id, $template, $backgroundColor = '', $frameColor = '', $frameSize = '', $caption = '', $type = '' )
	{
		$this->id = (int)$id;
	...
	{
		$this->imgs[] = new pageflipAlbumImg( $id, $scaling, $x, $y, $description );
	}
...
class pageflipAlbumImage
{
	...
	function pageflipAlbumImage( $id, $thumb, $width, $height )
	{
		$this->id = (int)$id;
		$this->thumb = $thumb;
...
class pageflipAlbumImg
{
	...
	function pageflipAlbumImg( $id, $scaling, $x, $y, $description )
	{
		$this->id = (int)$id;
...
class pageflipLayout
{
	...
	{
		$this->areas[$id] = new pageflipArea( $id, $X, $Y, $W, $H );
	}
...
class pageflipArea
{
	...
	function pageflipArea( $id, $X, $Y, $W, $H )
	{
		$this->id = (int)$id;
		$this->X = round( $X, 2 );
		$this->Y = round( $Y, 2 );
